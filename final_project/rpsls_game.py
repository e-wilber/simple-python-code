"""
Project: rpsls_game.py
Author: E Wilber
Last date modified: {12-11-23}

Rock Paper Scissors Lizard Spock game. The rules: Scissors decapitates lizard, Scissors cuts paper, paper covers rock,
rock crushes lizard, lizard poisons Spock, Spock smashes scissors, lizard eats paper, paper disproves Spock, Spock
vaporizes rock, and ofcourse, rock crushes scissors.
"""
